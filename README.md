...
For this option, you may first need to install [numpy](https://numpy.org/install/), [keras](https://keras.io/getting_started/), [mat4py](https://pypi.org/project/mat4py/) (to read .mat format) modules via *terminal* in your local machine.
